...
const messages = {
  confirm: {
    type: "success",
    text:
      "We've sent a confirmation message to your email. Follow the link there to activate your account."
  },
  password_mail: {
    type: "success",
    text:
      "We've sent a recovery email to your account. Follw the link there to reset your password."
  },
  email_changed: {
    type: "sucess",
